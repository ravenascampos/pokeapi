  ...
  return (
    <>
      ...
      <S.Wrapper>
        <S.Div>
          <S.ImgDiv>
            <S.Img src="https://i.pinimg.com/originals/18/d9/e1/18d9e1307018dbc76750ca7d5124fccd.png" />
          </S.ImgDiv>
          <S.FormBox
          ...
          >
            <S.FormFields>
              ...
              <S.LabelContainer>
                <S.FormContainer>
                  <S.StyleLabel>Nome Completo</S.StyleLabel>
                  <S.Input
                    type="text"
                    name="nome"
                ...
                <S.FormContainer>
                  <S.StyleLabel>Origem</S.StyleLabel>
                  <S.Select>
                  ...
                  <S.StyleLabel>Função</S.StyleLabel>
                  <S.Input
                    type="text"
                    name="funcao"
              ...
              <S.ErrorsDiv>
                ...
                {formik.errors.funcao && (
                  <S.ErrorTip>{formik.errors.funcao}</S.ErrorTip>
                )}
              </S.ErrorsDiv>
            </S.FormFields>
          </S.FormBox>
